...
$mlang = array (
	...
	'not_open_registration' => '<p>您好，如何注册成为本社区的成员：</p><br>
	<p>我们目前暂不开放用户的自由注册，但您可以通过一些有权限的老用户邀请注册。此外，如果您认同我们社区的主旨与思路，可以向站长发申请邀请您加入社区。
	新社区将会更多的结合我们开源软件中心的线下活动，因此，我们也欢迎想要参与我们线下活动的朋友与我们联系，加入到社区中来。</p>
	<p>站长电子邮件：oss@csip.org.cn <br>
	邮件内容请包含：
	你的网名或真实姓名，email地址，你的专业特长或专业爱好，你希望利用社区做什么（如，博客，提交新闻或技术文章等）。</p><br>
	注意：我们只接受IT领域的技术或非技术的网友的申请；当然，我们欢迎热爱开源软件运动，并能够为社区出一分力的朋友。<br>
	',
	'registered' => '注册成功了',
