...
$html = '<h5><a href="javascript:taghide();" target="_self">'.$blang['close'].'</a>TAG: '.$tagname.'&nbsp;&nbsp;&nbsp[<a href="http://yp.oss.org.cn/software/search.php?search='.$tagname.'" target="_blank" style="float:none;color:#1895DC;">了解她...</a>］</h5>
